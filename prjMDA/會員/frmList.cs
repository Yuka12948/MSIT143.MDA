...
namespace prjMDA
{
    public partial class frmList : Form
    {
        ...
        {
            InitializeComponent();
            //splitContainer3.BorderStyle = BorderStyle.FixedSingle;   // 婷薇 我在這裡~ \@"@
            //splitContainer5.BorderStyle = BorderStyle.FixedSingle;   // 婷薇 你在哪裡~ @"@/?
        }
        ...
        {
            if (txtListName.Text == "" || txtMemId.Text == "" || txtMovieId.Text=="")
                return;
